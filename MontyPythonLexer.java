...
public class MontyPythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IDellista", "AND", "OR", "NOT", "EQ", "COMMA", "SEMI", "LPAREN", "RPAREN", 
			"LCURLY", "RCURLY", "LSQUARE", "RSQUARE", "TWOPOINTS", "EXP", "MULT", 
			"DIV", "IDIV", "MOD", "SUM", "SUBT", "LESS", "LESSEQ", "BIGG", "BIGGEQ", 
			"EQUAL", "DIFF", "DINT", "DFLOAT", "INPUT", "PRINT", "WHILE", "IF", "ELIF", 
			"ELSE", "FOR", "IN", "RANGE", "DEF", "RETURN", "LSIZE", "LADD", "LREMOVE", 
			"INT", "FLOAT", "MMENOS", "STRING", "ID", "COMMENT", "WS"
		};
	}
